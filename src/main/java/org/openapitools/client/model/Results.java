...
import org.openapitools.client.model.ResultsRecordsInner;
...
public class Results {
  ...
  private List<ResultsRecordsInner> records = new ArrayList<>();

  public Results() {
  }

  public Results totalCount(Integer totalCount) {
  ...
  **/
  ...
  public Results links(List<Links> links) {
    
    this.links = links;
    return this;
  }

  public Results addLinksItem(Links linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public Results records(List<ResultsRecordsInner> records) {
    
    this.records = records;
    return this;
  }

  public Results addRecordsItem(ResultsRecordsInner recordsItem) {
  ...
  **/
  ...
  public List<ResultsRecordsInner> getRecords() {
    return records;
  }


  public void setRecords(List<ResultsRecordsInner> records) {
    this.records = records;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.totalCount, results.totalCount) &&
        Objects.equals(this.links, results.links) &&
        Objects.equals(this.records, results.records);
  }

  @Override
  public int hashCode() {
    return Objects.hash(totalCount, links, records);
  }
      ...
      if (jsonObj.get("records") != null && !jsonObj.get("records").isJsonNull()) {
        ...
        if (jsonArrayrecords != null) {
          ...
          for (int i = 0; i < jsonArrayrecords.size(); i++) {
            ResultsRecordsInner.validateJsonObject(jsonArrayrecords.get(i).getAsJsonObject());
          };
        }
      }
  }

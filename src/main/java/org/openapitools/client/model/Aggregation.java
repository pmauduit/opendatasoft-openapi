...
public class Aggregation {
  ...
  public static final String SERIALIZED_NAME_COU_NAME_EN = "cou_name_en";
  @SerializedName(SERIALIZED_NAME_COU_NAME_EN)
  private String couNameEn;

  public Aggregation() {
  }

  public Aggregation count(Integer count) {
  ...
  **/
  ...
  public Aggregation couNameEn(String couNameEn) {
  ...
  **/
  ...
  public String getCouNameEn() {
    return couNameEn;
  }


  public void setCouNameEn(String couNameEn) {
    this.couNameEn = couNameEn;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.count, aggregation.count) &&
        Objects.equals(this.couNameEn, aggregation.couNameEn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(count, couNameEn);
  }
  ...
  public String toString() {
    ...
    sb.append("    couNameEn: ").append(toIndentedString(couNameEn)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Aggregation
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Aggregation.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Aggregation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Aggregation` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      if ((jsonObj.get("cou_name_en") != null && !jsonObj.get("cou_name_en").isJsonNull()) && !jsonObj.get("cou_name_en").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `cou_name_en` to be a primitive type in the JSON string but got `%s`", jsonObj.get("cou_name_en").toString()));
      }
  }

...
public class Dataset {
  ...
  public Dataset links(List<Links> links) {
    
    this.links = links;
    return this;
  }

  public Dataset addLinksItem(Links linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(links, dataset);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Dataset.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Dataset` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

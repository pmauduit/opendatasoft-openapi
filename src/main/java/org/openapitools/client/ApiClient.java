...
public class ApiClient {
    ...
    private String basePath = "https://data.opendatasoft.com/api/v2";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://data.opendatasoft.com/api/v2",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://data.opendatasoft.com/api/v2
